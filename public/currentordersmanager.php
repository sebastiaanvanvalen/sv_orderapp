...
<head>
    ...
    <link rel="stylesheet" href="styles/currentorders.style.css">
    <link href="https://fonts.googleapis.com/css2?family=Dancing+Script:wght@500&display=swap" rel="stylesheet">
    <title>Smit & Voogt Current Orders Manager</title>
</head>

<body>

    <div class="menu">
        <button class="btn btn-success menu-btn current">HUIDIGE ORDERS</button>
        <button class="btn btn-primary menu-btn canceled">Naar Geannuleerde Orders</button>
        <button class="btn btn-primary menu-btn future">Naar: toekomstige Orders</button>
    </div>


    <div class="main-container">
        <div class="all-orders cont">
            <div class="all-orders-wrapper">
                <div class="unchecked-orders-container">
                    <h2>Ongelezen nieuwe Orders</h2>
                    <div class="unchecked-orders"></div>
                </div>
                <div class="checked-orders-container">
                    <h2>Ingevoerde Orders</h2>
                    <div class="checked-orders"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="scripts/getCurrentOrders.js" type="module"></script>
